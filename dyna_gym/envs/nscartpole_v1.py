...
The objective is to balance the pole + to keep the position of the cart along the x-axis within a time-varying interval.
"""
...
class NSCartPoleV1(gym.Env):
    ...
    def __init__(self):
        ...
        self.force_mag = 15.0
        self.nb_actions = 9 # number of discrete actions in [-force_mag,+force_mag]
